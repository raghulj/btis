...
//            SearchResult.setTitle("Search results for "+searchQuery);
    ...
    private String [] GetDataFromSite(String Str)
    {
         ...
         String uploadWebsite =  "http://"+controller.URL_BASE+"/php/mobile_search.php?q=";
    ...
    public String [] fetchDirectionsData(String str)
     {
        String uploadWebsite =  "http://"+controller.URL_BASE+"/godown/scripts/php/cityroutebackend_ol_mobile.php?org="+str;
         String [] ArrayOfData=null;
         StreamConnection c = null;
         InputStream s = null;
         StringBuffer b = new StringBuffer();
