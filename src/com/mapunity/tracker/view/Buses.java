...
public class Buses extends Form implements CommandListener{
        ...
        public Buses(Controller controller)
        {
            ...
            uploadWebsite =  "http://"+controller.URL_BASE+"/php/getStagePoints.php?type=route&routeno=";
            BusNowebsite = "http://"+controller.URL_BASE+"/php/getStagePoints.php?type=stop&stage=";
