...
public class TrafficCams extends List implements CommandListener{
          ...
          private String [] GetDataFromSite()
    {
         ...
         String uploadWebsite =  "http://"+controller.URL_BASE+"/cameras/mobile_cam_list.php";
 ...
 private void refreshImage()
  ...
  {
      String url = "http://"+controller.URL_BASE+"/cameras/images/"+str+".jpg";
 ...
 private void getTrafficSpots(){
     controller.showProgressBar();
      String uploadWebsite =  "http://"+controller.URL_BASE+"/php/trafficstatus.cache?dummy=ert43";
         String [] ArrayOfData=null;
         StreamConnection c = null;
         InputStream s = null;
         StringBuffer b = new StringBuffer();
